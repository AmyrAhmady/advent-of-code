...
impl Process {
    ...
    fn addr_arg(self: &mut Process, idx: u32) -> usize {
        ...
        match mode {
            0 => arg as usize,
            1 => panic!("something went wrong"), // you can hate for this error message...
            2 => (self.rb as isize + arg) as usize,
            _ => panic!("invalid param mode")
        }
    }

    fn step(self: &mut Process, mut put: impl FnMut(isize), mut get: impl FnMut() -> isize) -> u8 {
